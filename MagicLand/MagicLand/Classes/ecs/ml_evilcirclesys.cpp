...
#include "fsm/evilcircle/ml_waitstate.h"
...
,m_StateMachine(NULL) {
  ...
  if(m_StateMachine != NULL) {
    ...
    if(start_state != NULL && end_state != NULL) {
      ...
      evilcircle::MLWaitState* wait_state = new evilcircle::MLWaitState(entity);
      ML_SAFE_ASSERT(wait_state != NULL, "Memory Error");
